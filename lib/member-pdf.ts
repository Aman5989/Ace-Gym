...
export async function downloadMemberPdf(member: Member) {
  ...
  pdf.setFontSize(7);
  pdf.setTextColor(MUTED);
  // Generated on moved below the bottom border (margin is 10, so y > height - 10)
